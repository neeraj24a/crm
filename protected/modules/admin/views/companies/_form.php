    ...
    <div class="panel-body">
        ...
        <div class="col-lg-12">
			...
			<div class="col-lg-12">
				<div class="col-lg-12">
					<div class="form-group">
						<input type="checkbox" id="copy-original" />
						<label for="copy-original">
							Check If KC Info is same as original info.
						</label>
					</div>
				</div>
			</div>
            <div class="col-lg-12" id="kc-map">
            ...
            <div class="col-lg-12">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <?php 
                            $arr = AR::model()->findAll(array("condition" => "status = 1 AND deleted = 0")); 
                            $list = CHtml::listData($arr, 'id', 'first');
						?>
                        <?php echo $form->dropDownList($model,'ar',$list,array('empty' => 'Select AR','class'=>'form-control')); ?>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <?php 
                            $arr = RC::model()->findAll(array("condition" => "status = 1 AND deleted = 0")); 
                            $list = CHtml::listData($arr, 'id', 'first');
                        ?>
                        <?php echo $form->dropDownList($model,'rc',$list,array('empty' => 'Select RC','class'=>'form-control')); ?>
            ...
            <div class="col-lg-12">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <?php 
                            $arr = Admins::model()->findAll(array("condition" => "status = 1 AND deleted = 0")); 
                            $list = CHtml::listData($arr, 'id','first_name');
                        ?>
                        <?php echo $form->dropDownList($model,'admin',$list,array('empty' => 'Select Admin','class'=>'form-control')); ?>
            ...
            <div class="col-lg-12">
                <div class="col-lg-6">
                    <div class="form-group">
                        <?php echo $form->labelEx($model,'contract_start'); ?>
                        <?php 
                        ...
                        ?>
                        <?php echo $form->error($model,'contract_start'); ?>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <?php echo $form->labelEx($model,'contract_exp'); ?>
                        <?php 
                            $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                                'model' => $model,
                                'attribute' => 'contract_exp',
                                'options' => array(
                                    'dateFormat' => 'yy-mm-dd',     // format of "2012-12-25"
                                    'showOtherMonths' => true,      // show dates in other months
                                    'selectOtherMonths' => true,    // can seelect dates in other months
                        ...
                        ?>
                        <?php echo $form->error($model,'contract_exp'); ?>
                    </div>
                </div>
            </div>
...
function initialize() {
 ...
 function kcInitialize() {
  <?php if($model->kc_lat != "" && $model->kc_lng != ""): ?>
  var latLng = new google.maps.LatLng(<?php echo $model->kc_lat; ?>, <?php echo $model->kc_lng; ?>);
  <?php else : ?>
  var latLng = new google.maps.LatLng(42.86878055608344, -76.10512355781253);    
  <?php endif; ?>
...
$(document).ready(function(){
	$("#copy-original").on("click", function(){
		if($(this).is(":checked")){
			$("#kc-map").hide();
			$("#Companies_kc_lat").val($("#Companies_lat").val());
			$("#Companies_kc_lng").val($("#Companies_lng").val());
			$("#Companies_kc_address").val($("#Companies_address").val());
			$("#Companies_kc_address2").val($("#Companies_address2").val());
			$("#Companies_kc_city").val($("#Companies_city").val());
			$("#Companies_kc_state").val($("#Companies_state").val());
			$("#Companies_kc_country").val($("#Companies_country").val());
			$("#Companies_kc_zip").val($("#Companies_zip").val());
        } else {
			$("#kc-map").show();
			$("#Companies_kc_lat").val('');
			$("#Companies_kc_lng").val('');
			$("#Companies_kc_address").val('');
			$("#Companies_kc_address2").val('');
			$("#Companies_kc_city").val('');
			$("#Companies_kc_state").val('');
			$("#Companies_kc_country").val('');
			$("#Companies_kc_zip").val('');
		}
	});
})
</script>