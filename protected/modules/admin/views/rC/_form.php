...
<div class="panel panel-default">
    <div class="panel-heading">Rabbinical Coordinator Addition Form</div>
        ...
        <?php $form=$this->beginWidget('CActiveForm', array(
            ...
            'enableAjaxValidation'=>true,
                ...
                <div class="col-lg-12 m-t-20">
                    ...
                    <a href="<?php echo Yii::app()->createUrl("admin/rC"); ?>" class="mb-sm btn btn-warning pull-right">Back</a>
                </div>
            <?php $this->endWidget(); ?>
        </div>
    </div>
