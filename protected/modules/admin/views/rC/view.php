<div class="content-wrapper">
    <h3>Rabbinical Coordinator Details</h3>
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="col-lg-2 pull-right">
                        <a href="<?php echo Yii::app()->createUrl("admin/rC/update?id=" . $model->id); ?>" class="mb-sm btn btn-warning">Update</a>
                    </div>
                </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Company List
                    <div class="col-lg-2 pull-right">
                        <a href="<?php echo Yii::app()->createUrl("admin/companies/create?rc=".$model->id); ?>" class="mb-sm btn btn-warning">Add Company</a>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'dataProvider' => $company->arRcSearch($model->id, 'rc'),
//                            'filter' => $model,
                            'columns' => array(
                                'name',
								'jewish',
