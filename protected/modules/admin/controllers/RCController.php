...
class RCController extends Controller {
     ...
     * @param RC $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'rc-form') {
