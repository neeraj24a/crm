...
/**
 * This is the model class for table "rabbinical_coordinator".
 *
 * The followings are the available columns in table 'rabbinical_coordinator':
 * @property string $id
...
class RC extends BaseModel
{
	 ...
	 * @return RC the static model class
	 */
